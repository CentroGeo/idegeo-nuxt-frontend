...
const videoPortada = '/inicio/Portada_SIGIC_1_1.mp4';
const imgTarjetaVisualiza = '/inicio/tarjeta_visualiza.png';
const imgTarjetaAnaliza = '/inicio/tarjeta_analiza.png';
const imgTarjetaExplora = '/inicio/tarjeta_explora.png';
const imgTarjetaUsa = '/inicio/tarjeta_usa.png';
const imgExplorar = '/inicio/imagenexplorar.png';
const imgProfundizar = '/inicio/imagenprofundizar.png';
const imgAprovechar = '/inicio/imagenaprovechar.png';
const imgTener = '/inicio/imagentener.png';
const imgCompartir = '/inicio/imagencompartir.png';
